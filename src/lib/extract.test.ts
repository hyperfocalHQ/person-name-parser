...
describe('extractSuffix', () => {
  ...
  describe('multiple suffixes', () => {
    ...
    it('should stop at first non-suffix token', () => {
      const result = extractSuffix(['John', 'Smith', 'Jr', 'of', 'Chicago']);
      expect(result).toEqual({
        suffix: 'Jr',
        remainingTokens: ['John', 'Smith', 'of', 'Chicago'],
      });
    });
  });
  ...
  describe('with custom suffixes', () => {
    it('should use custom suffix set when provided', () => {
      ...
      const result = extractSuffix(['John', 'Smith', 'Certified'], customSuffixes);
      expect(result).toEqual({
        suffix: 'Certified',
        remainingTokens: ['John', 'Smith'],
      });
    ...
    it('should extract multiple custom suffixes', () => {
      ...
      const result = extractSuffix(['John', 'Smith', 'Certified', 'Verified'], customSuffixes);
      expect(result).toEqual({
